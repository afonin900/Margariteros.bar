window.STATE =
{
  ...
  "updatedAt": "2026-08-26T21:23:00+02:00",
  "finishedAt": null,
  "stages": [
    ...
    { "id": "build", "status": "active", "startedAt": "2026-08-26T19:17:00+02:00", "note": "1 из 5 тасков готовы" },
    { "id": "review", "status": "active", "startedAt": "2026-08-26T19:36:00+02:00", "note": "проверяется 2 из 5" },
    { "id": "final", "status": "pending" }
  ],
  "requirements": {
    "total": 36, "done": 7, "inTicket": 25, "inSpec": 0,
  ...
  "tickets": [
    ...
    { "id": "02", "title": "Точная food-safe копия ChoiceQR", "requirements": ["R04", "R05", "R06", "R08", "R09", "R20", "R21", "R24", "R25", "R26", "R27", "R28", "R29", "R32i"], "blockedBy": ["01"], "wave": 2, "zone": ["site/src/components/", "site/src/styles/", "site/public/"], "status": "repair", "startedAt": "2026-08-26T20:31:00+02:00", "retries": 0, "repairs": 1, "repairFindings": ["R06 требует measured overlay evidence ≤4 px", "mobile header перекрывает brand", "booking CTA обрезан", "food-tacos-tray содержит рюмки", "final captures содержат Astro dev toolbar"], "handoffs": 1 },
