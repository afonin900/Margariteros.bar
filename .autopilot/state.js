window.STATE =
{
  ...
  "tickets": [
    ...
    { "id": "04", "title": "Production-пакет и полная проверка", "requirements": ["R23", "R31i", "R06"], "blockedBy": ["03"], "wave": 4, "zone": ["site/Dockerfile", "site/tests/", "site/docs/", "CI/build scripts"], "status": "done", "startedAt": "2026-08-26T22:47:00+02:00", "finishedAt": "2026-08-26T23:05:00+02:00", "retries": 0, "repairs": 2, "repairFindings": ["release gate lacked reproducible Docker verification", "base image used mutable tag", "accessibility assertions and secret-scan wording needed precision"], "handoffs": 0, "files": ["site/Dockerfile", "site/.dockerignore", "site/src/pages/healthz.ts", "site/tests/production.test.ts", "site/scripts/", "site/docs/dokploy-runbook.md", "site/docs/quality-verification.md"], "tests": { "passed": 14, "failed": 0 }, "concerns": [] },
