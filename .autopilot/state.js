window.STATE =
{
  ...
  "stages": [
    ...
    { "id": "build", "status": "active", "startedAt": "2026-08-26T19:17:00+02:00", "note": "2 из 5 тасков готовы" },
    { "id": "review", "status": "active", "startedAt": "2026-08-26T19:36:00+02:00", "note": "проверяется 3 из 5" },
    { "id": "final", "status": "pending" }
  ],
  "requirements": {
    "total": 36, "done": 27, "inTicket": 5, "inSpec": 0,
  ...
  "tickets": [
    ...
    { "id": "03", "title": "Consent, атрибуция и честные события", "requirements": ["R10", "R15", "R16", "R17", "R18", "R19", "R30i", "R31i"], "blockedBy": ["02"], "wave": 3, "zone": ["site/src/lib/consent/", "site/src/lib/analytics/", "site/src/components/Consent*"], "status": "done", "startedAt": "2026-08-26T22:07:00+02:00", "finishedAt": "2026-08-26T22:45:00+02:00", "retries": 0, "repairs": 1, "repairFindings": ["contact_click отправляет phone PII", "nested attribution может обходить PII validation", "Reject отправляет analytics event вместо only consent update"], "handoffs": 0, "files": ["site/src/lib/consent/", "site/src/lib/analytics/", "site/src/components/ConsentBanner.astro", "site/tests/privacy.test.ts", "site/.env.example"], "tests": { "passed": 12, "failed": 0 }, "concerns": [] },
