...
Базовый сайт собран в коммите `5091a06`; актуальная ветка `codex/choiceqr-exact-ssr` содержит ChoiceQR-подобную оболочку и Emdash для трёх модулей сайта: редактируемой главной страницы, событий и повторно используемых профилей диджеев. Профиль хранит фотографию, локализованное описание и безопасные ссылки на Instagram и другие сети; событие выбирает основной профиль, а расширенная связь допускает несколько исполнителей. Интерфейс админки и названия полей — английские, публичные значения разделены на PL/EN/RU/ES. Планирование социальных публикаций, Postiz-мост и общий календарь из Emdash удалены решением владельца 1 сентября 2026 года. Статьи позже получат отдельный модуль и маршруты, а не будут смешаны с событиями. Тестовый Emdash защищён входом и имеет хотя бы одного настроенного пользователя; вход владельца ещё нужно подтвердить зарегистрированным ключом доступа или ссылкой на почту. Это не разрешение переключать основной домен. Тестовый R Club развёрнут отдельно; его ближайшая честная проверка — один оплаченный и закрытый кассовый чек со скидкой 10%, начислением 5 PLN партнёру и повторным чтением без дубля.
