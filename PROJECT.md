...
| Собственный сайт | PL/EN/RU/ES SSR-поверхность, согласие, безопасные ссылки и release gate проверены; результат сохранён в `5091a06` и удалённой ветке `codex/choiceqr-exact-ssr` | `site/`, `site/docs/quality-verification.md`, Issue #17 |
